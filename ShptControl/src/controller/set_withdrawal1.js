layui.define(function (exports) {
    ...
    function () {
       ...
       var render_table1 = function () {
           table.render({
               elem: '#setTable',
               url: layui.setter.requestUrl + 'api.php?c=withdraw_setting/withdrawSettingShow&type=1',
               cols: cols=[
                   [{
                       field: 'rank_des',
                       title: '等级名称',
       ...
       $('.addRule').click(function(){
            admin.popup({
                ...
                , area: ['600px', '550px']
                , success: function () {
                    view(this.id).render('/template/finance/addWithdrawal1', {});
                }
            });
       })
        table.on('tool(setTable)', function (obj) { //注：tool table 是 table  lay-filter="对应的值"
            ...
            if(layEvent == 'del'){
                ...
                admin.popup({
                    ...
                    , area: ['600px', '550px']
                    , success: function () {
                        view(this.id).render('/template/finance/addWithdrawal1', data);
                    }
                });
            }
        })
